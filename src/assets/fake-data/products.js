...
const getProductBySearch = (value) => {
    let res = [];
    let cartItems = products.filter(e=>e.title.includes(value));
    if(cartItems.length>0){
        cartItems.forEach(e=>{
            res.push({
                ...e,
...
// filter value từ product cha

// getProductBySearch('Áo')

// const getCartItemsSearch = (cartItems) => {
//     let res = []
//     if (cartItems.length > 0) {
//         cartItems.forEach(e => {
//             let product = getProductBySearch('Áo')
//             console.log(product)
//             res.push({
//                 ...e,
//                 product: product
